...
SPI_Handle spiHandle = {
    ...
    .init.interruptEnable = 1, // Specifies the SPI interrupt enable.
...
int main(void)
{
    ...
    printf("Starting transmission in non blocking mode...\n");
    ...
    {
        // Transmit the data
        if (SPI_Transmit_IT(&spiHandle, &txBuffer, 1) != SPI_OK)
        {
